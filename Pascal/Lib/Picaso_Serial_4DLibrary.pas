unit Picaso_Serial_4DLibrary;
interface
uses windows ;
type
{$I Picaso_Types4D.inc}
const
{$I Picaso_CONST4DSERIAL.INC}
{$I Picaso_CONST4D.INC}
  Err_OK      = 0 ;
  Err_Timeout = 1 ;
  Err_NAK     = 2 ;
type
...
implementation
{$I Picaso_Intrinsic4DRoutines.pas}
...
{$I Picaso_Compound4DRoutines.pas}
initialization
 Callback4D := nil ;
 Callback4DCmd := nil ;
end.
